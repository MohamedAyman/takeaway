package com.payroll.player2.service;

import com.payroll.player2.dto.Player;
import com.payroll.player2.kafka.KafkaProducer;
...
import static com.payroll.player2.utils.Utils.print;
...
public class PlayerService {
    ...
    public void playTurn(int number) {
        ...
        String printNewNumber = String.format("New number %d", newNumber);
